...
/*   Updated: 2023/04/28 17:10:33 by zessadqu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap :: ClapTrap():_hitPoint(100) , _energy(50) , _attackDamage(20){
           std::cout << "the ClapTrap default constructor is called "<<std::endl;
}
ClapTrap :: ClapTrap(std::string name): _name(name), _hitPoint(100) , _energy(50) , _attackDamage(20) {
